...
WM_BYTE VMCLASS_PREFIX WMC_Custom(WM_BYTE opcode)
{
	...
	switch(opcode)
	{
		...
		case 0x80:		// SCNTF - powiadomienie MW o niespe�nieniu asercji
			...
			break;
		case 0x81:		// SCRST - rozpocz�cie przetwarzania cyklu od pocz�tku
		case 0x82:		// SCHLT - przerwanie wykonywania programu (przej�cie do obs�ugi zapisu wyj�� I/O sterownika)
			break;
#endif
		default:
			bResult = WM_UNKNOWN;
